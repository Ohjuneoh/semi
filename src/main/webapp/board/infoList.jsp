...
<div class="container my-3">
	<div class="row mb-3">
		...
		<div class="col-12">
			<h1 class="border bg-light fs-4 p-2">정보 게시글 목록</h1>
		</div>
	</div>
	<div class="row mb-3">
		<div class="col-12">		
					...
					<nav>
						<ul class="pagination justify-content-center">
							<li class="page-item <%=pageNo <= 1 ? "disabled" : "" %>">
								<a class="page-link" href="infoList.jsp?page=<%=pageNo - 1 %>">이전</a>
							</li>
<%
		for(int num = pagination.getBeginPage(); num <= pagination.getEndPage(); num++) {
%>
							<li class="page-item <%=num == pageNo ? "active" : "" %>">
								<a class="page-link" href="infoList.jsp?page=<%=num %>"><%=num %></a>
							</li>
<%
		}
%>					
							<li class="page-item <%=pageNo >= pagination.getTotalPages() ? "disabled" : "" %>">
								<a class="page-link" href="infoList.jsp?page=<%=pageNo + 1 %>">다음</a>
							</li>
						</ul>
					</nav>
				</div>
