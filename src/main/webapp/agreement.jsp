...
<link rel="stylesheet" href="/semi/resources/css/agreement.css">
</head>
<body>
...
<div class="container">
	<div class="row mb-3">
    	<div class="col-12">
        	<h1 class="border bg-light fs-4 p-2">개인정보 수집동의</h1>
      	</div>
   	</div>
	<div class="row mb-3">
		<div class="col-12">
				...
				<form class="row g-3" method="post" action="membership-insert.jsp">
	 				<div class="col-md-12">
						<div>
							<div class="form-check">
  								...
  								<label  class="form-check-label" for="flexCheckDefault" >전체 동의하기</label>
					...
					<div class="col-md-12">
						<div>
							<div class="form-check">
  								<input type="checkbox" class="form-check-input" value="" id="flexCheckDefault">
  								<label  class="form-check-label" for="flexCheckDefault" style="color:green;font-size:15px;">[필수]</label><label>HELF 이용약관 </label>
							</div>
							<div class="col-md-12" style ="overflow:scroll; ">
							 <p>
								이 약관은 HELF (이하 '회사' 라고 합니다)가 제공하는 제반 서비스의 이용과 관련하여 회사와 회원과의 권리, 의무 및 책임사항, 기타 필요한 사항을 규정함을 목적으로 합니다.</p>
							</div>
							<div class="form-check">
  								<input type="checkbox" class="form-check-input" value="" id="flexCheckDefault">
  								<label  class="form-check-label" for="flexCheckDefault" style="color:green;font-size:15px;">[필수]</label><label>개인정보 수집 및 이용</label>
							</div>
							<div class="col-md-12 custom-scrollbar"  >
