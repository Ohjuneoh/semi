...
<%
   ...
   int totalRows = mymemDao.getTotalPersonalMyMembershipRows(userId);
      
   Pagination pagination = new Pagination(pageNo, totalRows);
      
   // 로직수행 
   List<MyMembership> myMembershipList = mymemDao.getPersonalMyMembershipById(userId, pagination.getBegin(), pagination.getEnd());
...
%>
         ...
         <div class="alert alert-danger">
            <strong>잘못된 접근</strong> 이용권을 모두 사용하였으므로 개인수업 신청을 할 수 없습니다.
         </div>
<%
   }
%>
