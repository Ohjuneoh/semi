...
public class MyMembershipDao {
	...
	public List<MyMembership> getPersonalMyMembershipById(String userId, int begin, int end) {
	      return DaoHelper.selectList("MyMembershipDao.getPersonalMyMembershipById", rs -> {
	         MyMembership myMembership = new MyMembership();
	         myMembership.setNo(rs.getInt("my_membership_no"));
